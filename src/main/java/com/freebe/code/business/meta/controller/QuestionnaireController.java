...
public class QuestionnaireController {
	...
	@ApiOperation(value = "查询当前用户已填写的问卷ID")
	@GetMapping("answered")
	public ResultBean<List<QuestionnaireVO>> queryAnswered() throws CustomException {
		return ResultBean.ok(questionnaireService.answered());
	}
